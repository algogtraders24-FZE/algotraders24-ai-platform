//+------------------------------------------------------------------+
//| Wizard: EMA9x21 Cross, No Filter, Standard Risk — AUTO-GENERATED from spec (MQL4/MT4)   |
...
void OpenTrade(int direction, double slDist, double tpDist)
  {
   ...
   int ticket = OrderSend(Symbol(), cmd, lots, price, 20,
                           ...
                           "Wizard:EMA9x21Cross,NoFilter,StandardRisk", InpMagic, 0, (direction > 0) ? clrBlue : clrRed);
  }
...
void OnTick()
  {
   ...
   double trigger_emaF = iMA(Symbol(), 0, 9, 0, MODE_EMA, PRICE_CLOSE, 1);
   double trigger_emaS = iMA(Symbol(), 0, 21, 0, MODE_EMA, PRICE_CLOSE, 1);
   double atrRisk = iATR(Symbol(), 0, 14, 1);
   double trigger_emaF_prev = iMA(Symbol(), 0, 9, 0, MODE_EMA, PRICE_CLOSE, 2);
   double trigger_emaS_prev = iMA(Symbol(), 0, 21, 0, MODE_EMA, PRICE_CLOSE, 2);
