//+------------------------------------------------------------------+
//| EMA9x21 Cross + RSI Filter — AUTO-GENERATED from spec (MQL4/MT4)   |
...
void OpenTrade(int direction, double slDist, double tpDist)
  {
   ...
   int ticket = OrderSend(Symbol(), cmd, lots, price, 20,
                           ...
                           "EMA9x21Cross+RSIFilter", InpMagic, 0, (direction > 0) ? clrBlue : clrRed);
  }
...
void OnTick()
  {
   ...
   double ema9 = iMA(Symbol(), 0, 9, 0, MODE_EMA, PRICE_CLOSE, 1);
   ...
   double ema9_prev = iMA(Symbol(), 0, 9, 0, MODE_EMA, PRICE_CLOSE, 2);
   double ema21_prev = iMA(Symbol(), 0, 21, 0, MODE_EMA, PRICE_CLOSE, 2);
