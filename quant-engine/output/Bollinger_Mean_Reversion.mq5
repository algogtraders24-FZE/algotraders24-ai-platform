//+------------------------------------------------------------------+
//| Bollinger Mean Reversion — AUTO-GENERATED from spec        |
...
void OpenTrade(int direction, double slDist, double tpDist)
  {
   ...
   req.deviation=20; req.magic=InpMagic; req.comment="BollingerMeanReversion"; req.type_filling=ORDER_FILLING_IOC;
   OrderSend(req, res);
  }
