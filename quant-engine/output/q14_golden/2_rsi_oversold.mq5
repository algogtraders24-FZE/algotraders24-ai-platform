//+------------------------------------------------------------------+
//| Golden RSI Oversold — AUTO-GENERATED from spec        |
...
void OpenTrade(int direction, double slDist, double tpDist)
  {
   ...
   req.deviation=20; req.magic=InpMagic; req.comment="GoldenRSIOversold"; req.type_filling=ORDER_FILLING_IOC;
   OrderSend(req, res);
  }
...
void OnTick()
  {
   ...
   bool longSignal  = (rsi14 < 30);
   bool shortSignal = (rsi14 > 70);
