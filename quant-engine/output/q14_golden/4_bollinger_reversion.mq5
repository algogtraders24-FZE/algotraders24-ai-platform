//+------------------------------------------------------------------+
//| Golden Bollinger Reversion — AUTO-GENERATED from spec        |
...
void OpenTrade(int direction, double slDist, double tpDist)
  {
   ...
   req.deviation=20; req.magic=InpMagic; req.comment="GoldenBollingerReversion"; req.type_filling=ORDER_FILLING_IOC;
   OrderSend(req, res);
  }
