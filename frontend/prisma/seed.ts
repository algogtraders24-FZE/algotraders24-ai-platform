...
async function seedPlans() {
  const plans = [
    ...
    { id: "pro", name: "Pro", priceMonthly: 29, priceYearly: 279, sortOrder: 2, features: ["10,000 AI credits / month", "5 AI agents", "25 automations", "200 knowledge documents", "5 GB storage", "API access", "3 team members"] },
    { id: "elite", name: "Elite", priceMonthly: 99, priceYearly: 949, sortOrder: 3, features: ["50,000 AI credits / month", "20 AI agents", "100 automations", "1,000 knowledge documents", "25 GB storage", "API access", "Priority support", "Custom branding", "10 team members"] },
    { id: "enterprise", name: "Enterprise", priceMonthly: 499, priceYearly: 4790, sortOrder: 4, features: ["500,000 AI credits / month", "100 AI agents", "1,000 automations", "Unlimited knowledge documents", "500 GB storage", "API access", "Dedicated support & SLA", "Custom branding", "100 team members"] },
  ];
