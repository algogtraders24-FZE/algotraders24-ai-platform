...
export type PriceReference = {
    ...
    readonly reason: "BID" | "ASK";
};
export declare function priceReferenceKind(ref: PriceReference): PriceReferenceKind;
export declare function validatePriceReference(ref: PriceReference, path: string): ValidationResult;
