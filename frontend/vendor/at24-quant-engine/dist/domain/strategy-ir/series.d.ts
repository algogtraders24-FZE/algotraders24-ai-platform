...
export declare function seriesOffset(series: PriceSeriesField | ReservedPriceSeriesField, offset: number): SeriesOffsetRef;
/**
 ...
 * non-optional.
 */
export declare function validateSeriesOffset(ref: SeriesOffsetRef): boolean;
