...
export type MarketStructureEvent = SwingPoint | BreakOfStructure | ChangeOfCharacter | MarketStructureShift | LiquidityLevel | LiquiditySweep | FairValueGap | OrderBlock | Displacement;
