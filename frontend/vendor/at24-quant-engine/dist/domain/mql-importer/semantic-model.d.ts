 ...
 */
export type MQLOrderStyle = "OrderSend" | "CTrade.Buy" | "CTrade.Sell" | "CTrade.PositionOpen" | "CTrade.BuyLimit" | "CTrade.SellLimit" | "CTrade.BuyStop" | "CTrade.SellStop" | "CTrade.BuyStopLimit" | "CTrade.SellStopLimit";
 ...
 * never a guess.
 */
export type RiskLegBinding = {
    readonly kind: "fixed-distance";
    readonly distance: number;
} | {
    readonly kind: "atr-multiple";
...
export type UnsupportedCategory = "ICUSTOM" | "DLL_IMPORT" | "WEBREQUEST" | "EXTERNAL_FILE" | "UNRESOLVED_CROSS_FILE_CALL" | "UNRESOLVED_DYNAMIC_CALL" | "UNKNOWN_INDICATOR" | "UNSUPPORTED_TRADE_EVENT" | "ACCOUNT_DEPENDENCY" | "BROKER_CONSTRAINT_DEPENDENCY";
...
export type EntryConditionOperand = {
    readonly kind: "indicator";
    readonly ref: IndicatorReferenceValue;
} | {
 ...
 * back to.
 */
export type PendingOrderManagementFunctionName = "OrderModify" | "OrderDelete" | "PositionModify" | "PositionClose" | "CTrade.OrderModify" | "CTrade.OrderDelete" | "CTrade.PositionModify" | "CTrade.PositionClose";
/**
