...
export type ExpressionNode = LiteralNode | IdentifierNode | UnaryExpressionNode | BinaryExpressionNode | AssignmentExpressionNode | CallExpressionNode | MemberExpressionNode | IndexExpressionNode | ConditionalExpressionNode;
...
export type StatementNode = BlockStatementNode | IfStatementNode | ReturnStatementNode | ExpressionStatementNode | VariableDeclarationStatementNode | ForStatementNode | UnparsedStatementNode;
