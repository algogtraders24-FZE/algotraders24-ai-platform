...
export type PendingOrderManagementOperation = {
    ...
    readonly newDistanceFromClose: DistanceSpec;
} | {
    readonly kind: "MODIFY_LIMIT";
    readonly newDistanceFromClose: DistanceSpec;
} | {
    readonly kind: "MODIFY_EXPIRATION";
 ...
 */
export declare const MQL_ORDER_TYPE_CONSTANT_MAP: Readonly<Record<string, {
    readonly orderType: "LIMIT" | "STOP";
    readonly side: "BUY" | "SELL";
}>>;
export declare function hasPendingOrderManagement(policy: PendingOrderManagementPolicy | undefined): boolean;
/**
 ...
 */
export declare function executableRules(policy: PendingOrderManagementPolicy): readonly PendingOrderManagementRule[];
/** Q0.13 — structural validation only, mirroring every prior sprint's domain/*.ts pattern (Q0.2/Q0.7/Q0.10). */
export declare function validatePendingOrderManagementPolicy(policy: PendingOrderManagementPolicy): ValidationResult;
