const WORST = { SUPPORTED: 0, PARTIAL: 1, UNSUPPORTED: 2, BLOCKED: 3 };
 ...
 */
export function computeExecutionCompatibility(ir, targetFidelity) {
    const features = [];
    ...
    const overallStatus = features.reduce((acc, f) => worstOf(acc, f.status), "SUPPORTED");
