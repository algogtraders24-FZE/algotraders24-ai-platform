 ...
 */
export function createStaticBarDetailProvider(childBars, childTimeframe, providerId = "StaticBarDetailProvider") {
    ...
    return {
        ...
        getDetail(query) {
            ...
            const inWindow = sorted.filter((b) => b.instrument.symbol === query.parent.symbol && b.timestamp > openTimestamp && b.timestamp <= closeTimestamp);
