...
export function timeframeDurationMs(tf) {
 ...
 */
export function isValidChildTimeframe(parent, child) {
...
export function expectedChildCount(parent, child) {
