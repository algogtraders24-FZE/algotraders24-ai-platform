...
import { type BarFillOutcome, type ProtectiveExitOutcome } from "../simulation/bar-fill-model.js";
/**
 ...
 * semantics.
 */
export declare function resolveIntrabarOrderFill(order: SimulationOrder, sequence: IntrabarSequence, instrument: Instrument, detailTimeframe: Timeframe, spreadModel: SpreadModel, slippageModel: SlippageModel): BarFillOutcome;
/**
 ...
 */
export declare function resolveIntrabarProtectiveExit(side: "BUY" | "SELL", stopLoss: number | undefined, takeProfit: number | undefined, sequence: IntrabarSequence, instrument: Instrument, detailTimeframe: Timeframe): ProtectiveExitOutcome;
