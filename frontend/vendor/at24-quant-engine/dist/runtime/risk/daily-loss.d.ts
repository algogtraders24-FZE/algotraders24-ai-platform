 ...
 */
export declare function evaluateDailyLossLimit(spec: RiskSpecification, dailyLoss: DailyLossContext): RiskConstraintResult;
/**
 ...
 */
export declare function computeTradingDayKey(timestampMs: number, dayBoundaryOffsetMinutes: number): string;
export declare function isSameTradingDay(t1: number, t2: number, dayBoundaryOffsetMinutes: number): boolean;
