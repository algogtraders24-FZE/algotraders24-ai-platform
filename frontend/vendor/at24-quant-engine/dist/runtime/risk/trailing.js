 ...
 */
export function evaluateTrailingStop(rule, direction, entryPrice, currentPrice, currentStopLoss, currentAtr) {
    ...
    try {
        ...
        return {
            triggered: false,
            violation: makeViolation("TRAILING_CONSTRAINT", "BLOCKING", e.message, null, null, "MISSING_REQUIRED_VALUE"),
        };
    }
