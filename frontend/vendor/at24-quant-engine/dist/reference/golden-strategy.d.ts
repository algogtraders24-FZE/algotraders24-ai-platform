 ...
 */
export declare const GOLDEN_STRATEGY_DEFAULT_POSITION_SIZE_QUANTITY = 1;
export declare const GOLDEN_STRATEGY_DEFAULT_STOP_LOSS_DISTANCE = 5;
export declare const GOLDEN_STRATEGY_DEFAULT_TAKE_PROFIT_R_MULTIPLE = 2;
