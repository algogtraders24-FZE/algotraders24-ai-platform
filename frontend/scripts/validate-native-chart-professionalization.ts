...
async function indicatorStateTests(): Promise<void> {
  ...
  // are legitimate new panel ids (their own sub-panel row each, never
  // overlaid on price), added alongside price/volume/rsi/macd, not a
  // change to D2.7.5's own grouping mechanism itself.
