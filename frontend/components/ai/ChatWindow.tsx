  ...
  if (messages.length === 0 && !thinking) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center">
        <p className="text-sm font-semibold text-slate-300">Start your first conversation</p>
        ...
        <Link href="/dashboard/knowledge" className="text-xs font-medium text-indigo-400 hover:text-indigo-300">
