import type { Token, TokenType, SourcePosition } from "../../domain/mql-importer/token.js";
...
export function tokenize(sourceText: string): readonly Token[] {
  const tokens: Token[] = [];
  let offset = 0;
  let line = 1;
  let column = 1;
  ...
  function push(type: TokenType, value: string, start: SourcePosition): void {
