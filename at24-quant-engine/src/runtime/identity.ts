 ...
 */
export function computeSemanticStrategyHash(spec: StrategySpec): string {
 ...
 * instead.
 */
export function computeStrategyIdentityHash(spec: StrategySpec, indicatorVersions: IndicatorVersionPins): string {
  const { metadata: _metadata, ...semantic } = spec;
 ...
 */
export function computeExperimentIdentityHash(input: ExperimentIdentityInput): string {
