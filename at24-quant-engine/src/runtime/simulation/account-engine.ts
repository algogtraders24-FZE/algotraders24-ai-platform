...
export function createAccount(initialBalance: number, asOf: number): Account {
...
export function applyFill(account: Account, grossPnl: number, fee: number, timestamp: number): Account {
...
export function markToMarket(account: Account, unrealizedPnl: number, timestamp: number): Account {
