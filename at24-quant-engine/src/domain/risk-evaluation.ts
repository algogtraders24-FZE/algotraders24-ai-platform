...
export type RiskViolationCode =
  ...
  | "BREAKEVEN_CONSTRAINT"
  | "TRAILING_CONSTRAINT"
  | "PARTIAL_CLOSE_CONSTRAINT";
 ...
 */
export type RiskViolationReason =
  | "BELOW_MINIMUM"
  | "EXCEEDS_MAXIMUM"
  | "AT_OR_BEYOND_LIMIT"
  ...
  | "INVALID_DIRECTION_RELATIVE_TO_ENTRY"
...
export type RiskAction =
  ...
  | { readonly type: "ALLOW_ENTRY"; readonly orderType?: OrderTypeIR; readonly limitPrice?: number; readonly stopPrice?: number }
  | { readonly type: "REJECT_ENTRY" }
  | { readonly type: "MOVE_STOP"; readonly newStopPrice: number; readonly sourceRule?: "BREAKEVEN" | "TRAILING" }
  | { readonly type: "PARTIAL_CLOSE"; readonly closePercent: number }
  | { readonly type: "FORCE_EXIT_REQUIRED"; readonly reasonCode: "MAX_HOLDING_PERIOD" };
