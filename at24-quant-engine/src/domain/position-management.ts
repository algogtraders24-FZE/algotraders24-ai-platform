...
export function extractPositionManagementPolicy(spec: RiskSpecification): PositionManagementPolicy {
  return {
...
export function hasPositionManagement(policy: PositionManagementPolicy): boolean {
...
export type PositionManagementInstruction =
  | { readonly kind: "STOP_ADJUSTMENT"; readonly instruction: StopAdjustment }
  | { readonly kind: "PARTIAL_CLOSE"; readonly instruction: PartialCloseInstruction }
  | { readonly kind: "FORCED_EXIT"; readonly instruction: ForcedExitInstruction }
  | { readonly kind: "NONE" };
 ...
 */
export function derivePositionManagementInstruction(result: RiskEvaluationResult, previousStopPrice?: number): PositionManagementInstruction {
