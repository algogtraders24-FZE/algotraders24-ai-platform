...
export interface AIStrategyCompilerInput {
  ...
  readonly entryConditions: readonly { readonly direction: "BUY" | "SELL"; readonly condition: Expression }[];
  readonly exitConditions: readonly { readonly condition: Expression; readonly appliesTo?: "BUY" | "SELL" }[];
