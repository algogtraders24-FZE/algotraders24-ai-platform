...
export function freezeStrategyVersion(spec: StrategySpec, publishedAt: number): StrategyVersionRecord {
  return {
...
export function verifyStrategyVersionIntegrity(record: StrategyVersionRecord): boolean {
