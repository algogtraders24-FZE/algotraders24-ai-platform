...
export const REF_EMA_CROSSOVER_DIALECT = "MQL5" as const;
...
export const REF_EMA_CROSSOVER_IMPORT_STAGES: readonly StageResult[] = [importStages.IMPORTED, importStages.PARSED, importStages.IR_VALID, importStages.EXECUTION_VALID];
...
export const REF_EMA_CROSSOVER_IR: StrategyIR = importResult.ir;
...
export const REF_EMA_CROSSOVER_SPEC: StrategySpec = reduction.strategySpec;
 ...
 */
export function buildRefEmaCrossoverSpec(): StrategySpec {
