...
OnTick() entry gate) run against REAL XAUUSD_EXNESS candles already
...
Q_ENTANGLEMENT = 0.60
Q_TUNNELPROB = 0.70
ATR_SL_MULT, ATR_TP_MULT = 2.0, 3.2
TRAIL_ATR_MULT = 1.8
FIXED_LOT = 0.01
MAX_TRADES_DAY = 2
...
if __name__ == "__main__":
    ...
    import json
    with open(r"E:\algotraders24-ai-platform\ea-research\marketplace-research\m14-catalog-import\quantum_gold_ai_trades.json", "w") as f:
        json.dump([{**t, "entry_time": t["entry_time"].isoformat(), "exit_time": t["exit_time"].isoformat()} for t in trades], f, indent=2)
    print("Trades written to quantum_gold_ai_trades.json")
