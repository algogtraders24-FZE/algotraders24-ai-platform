...
string AT24_PostJson(const string path, const string bodyJson)
{
   ...
   uchar postData[];
   // Real bug found live (2026-09-22, via AT24 Gold Range Breaker sharing
   // this same helper): StringToCharArray's trailing-null behavior when an
   // explicit count is passed is not guaranteed the same across MT5
   // builds. The old code assumed one was always appended and
